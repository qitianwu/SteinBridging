...
if __name__ == "__main__":
    ...
    datadir = '/home/wuiron/SteinBridging/data/' # add your directory for datasets
    ...
    with open(datadir+'Two_Spiral_.pkl', 'wb') as f:
    ...
    with open(datadir+'Two_Circle_.pkl', 'wb') as f:
	    pickle.dump(true_sample, f, pickle.HIGHEST_PROTOCOL)
