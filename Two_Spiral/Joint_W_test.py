...
show_size = 5000 # num of generated samples to test
...
with open(datadir+dataset+'_.pkl', 'rb') as f:
...
saver.restore(sess, save_path=workdir+'/'+method+'/model/280000')
...
circle_ratio = 0.5
start, sd  = 120, 0.5
degrees, deg2rad = 360.0, (2 * np.pi) / 360.0
start = start * deg2rad
NC1 = int(NC / 2.0)
NC2 = NC - NC1
...
for i in range(center.shape[0]):
    n_s_i = [center[i]+(2*np.random.rand(X_dim)-1)*sd for j in range(10)]
    n_s.append(n_s_i)
